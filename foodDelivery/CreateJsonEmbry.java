...
*/
    ...
    protected void createPeople()
    {
        ...
        people.add(new Person( "Renee Glauser", "rglauser@cox.net", null, null ));  // no august
        people.add(new Person( "Steven DiLeonardo", "svdileonardo@verizon.net", null, null ));
        people.add(new Person( "Nancy Larson", "alnancylarson@gmail.com", null, null ));
        people.add(new Person( "Heather Young", "heatherlyoung@verizon.net", null, null )); //Saturday
        people.add(new Person( "Carolyn Murphy", "a7492097@aol.com", null, null ));
        // people.add(new Person( "Theresa Low", "lowtm@verizon.net", null, null));  //Saturday  - moved
        people.add(new Person( "Megan Hartin", "Hartin5@cox.net", null, null));
        //people.add(new Person( "Kathy Eckert", "piano4funva-kathy@yahoo.com", null, null));  //Sunday
